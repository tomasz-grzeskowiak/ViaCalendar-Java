...
public class EventServiceDatabase implements EventService {
    private static final Logger log = LoggerFactory.getLogger(EventServiceDatabase.class);
    private final EventRepository eventRepository;
    private final UserRepository userRepository;
    public EventServiceDatabase(EventRepository eventRepository, UserRepository userRepository) {
    ...
    public void update(EventProto payload) {
        ...
        User creator = userRepository.findById(payload.getCreatorId()).orElseThrow();
        Event event = new Event(payload);
    ...
    public EventProtoList getMany() {
        ...
        for (Event event : events) {
            EventProto eventProto = ProtoUtilities.parseEventToProto(event);
